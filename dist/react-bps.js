...
var debug = process && process.env && "development" === 'debug';
  ...
  return function (WrappedComponent) {
    ...
    return _temp2 = _class = function (_Component) {
      ...
      function ComponentWithSizes() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ComponentWithSizes.__proto__ || Object.getPrototypeOf(ComponentWithSizes)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          initialSizes: getWindowSizes(),
          propsToPass: parseMappedSizesToProps(getWindowSizes(), _this.props)

          /* Dispatching & Throttling */

        }, _this.dispatchSizes = function () {
          var propsToPass = parseMappedSizesToProps(getWindowSizes(), _this.props);

          if (shallowDiff(propsToPass, _this.state.propsToPass)) {
            _this.setState({ propsToPass: propsToPass });
          }
        }, _this.throttledDispatchSizes = lodash_throttle(_this.dispatchSizes, 200), _temp), possibleConstructorReturn(_this, _ret);
      }
    ...
    }(React.Component), _class.displayName = 'withSizes(' + getDisplayName(WrappedComponent) + ')', _temp2;
  };
};
